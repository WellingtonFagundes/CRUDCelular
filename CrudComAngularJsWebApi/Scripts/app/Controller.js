app.controller("crudCtrl", function($scope, crudService) {
    ...
    function obterCelulares() {
        ...
        celularesData.then(function (celular) {
            ...
            toastr["error"]("Erro ao obter os celulares", "CRUD com MVC e AngularJS");
        });
    ...
    $scope.excluirCelular = function(celular) {
        ...
        celularData.then(function(data) {
            ...
            if (data.status == 200) {
                ...
                toastr["success"]("Celular excluído com sucesso!", "CRUD com MVC e AngularJS");
            }
            obterCelulares();
        },function() {
            toastr["error"]("Erro ao excluir", "CRUD com MVC e AngularJS");
